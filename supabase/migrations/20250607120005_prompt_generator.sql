-- Prompt generator tables, storage bucket, functions, triggers
-- (from scripts/10-create-prompt-generator-tables.sql)
...
CREATE TABLE IF NOT EXISTS public.prompts (
    ...
    enhancement_status VARCHAR(20) DEFAULT 'pending',
...
-- 7. STORAGE BUCKET FOR PORTFOLIO SCREENSHOTS
INSERT INTO storage.buckets (id, name, public)
VALUES ('portfolio-screenshots', 'portfolio-screenshots', true)
ON CONFLICT (id) DO NOTHING;

-- 8. STORAGE POLICIES FOR PORTFOLIO SCREENSHOTS
...
DROP TRIGGER IF EXISTS update_portfolio_uploads_updated_at ON public.portfolio_uploads;
